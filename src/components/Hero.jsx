...
const Hero = () => {
  return (
    <div className="relative bg-gradient-to-br from-gray-900 via-gray-800 to-black text-white border-b border-neutral-700 pb-10 lg:mb-35">
      <div className="container mx-auto px-6 lg:px-16 py-16 flex flex-wrap items-center">
        {/* Left Section */}
        <div className="w-full lg:w-1/2">
          <div className="flex flex-col items-center lg:items-start">
            <motion.h1
              ...
              initial="hidden"
              animate="visible"
              className="pb-6 text-5xl lg:text-7xl font-extrabold tracking-tight text-center lg:text-left"
            >
            ...
            <motion.span
              ...
              initial="hidden"
              animate="visible"
              className="text-2xl lg:text-3xl font-medium tracking-wide text-center lg:text-left"
            >
            ...
            <motion.p
              ...
              initial="hidden"
              animate="visible"
              className="mt-6 text-lg lg:text-xl font-light text-center lg:text-left max-w-lg"
            >
              {HERO_CONTENT}
            </motion.p>
            <motion.div
        ...
        <div className="w-full lg:w-1/2 mt-12 lg:mt-0">
          <div className="relative">
            ...
            <motion.div
              ...
              className="absolute bottom-[-20px] left-1/2 transform mt-28 -translate-x-1/2 text-center"
            >
